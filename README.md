...
| | Resources that use # headers are #acl, #sg:vpc:optionalrg, #vpn:subnet:optionalrg.
...
| Rules | Protocols are icp:type:code or tcp:port_min:port_max or udp:port_min:port_max or empty. | 
