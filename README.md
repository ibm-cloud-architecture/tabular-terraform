...
| --- | --- |
| Files | Related resources are grouped together in generated files, but individual files can also be generated by using -i command argument excluding security group which have separate resources for each rule. |
