...
| Resource Groups | As mentioned in terraform docs, terraform destroy only removes the terraform state information and does not delete the resource group.
...
| --- | --- | --- | --- |
| 0.0.0.0.6 | 2019-12-08 | 0.20.0+ | Refer to sheet change 0002.  |
...
| --- | --- | --- | --- |
| 0002 | 0.0.0.0.6 | acls | Added acls sheet to shared. |
| 0001 | 0.0.0.0.5 | resourcegroups | Added resourcegroups sheet to shared. |
| | | instances | Renamed column boot_volume to boot_volume_name and added column boot_volume_encryption, both columns are optional arguments. |
