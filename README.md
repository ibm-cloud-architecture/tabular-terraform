...
| | Protocol tcp:port_min:port_max where port_min is 1 to 65535 and port_max is 1 to 65535. | 
| | Protocol udp:port_min:port_max where port_min is 1 to 65535 and port_max is 1 to 65535. | 
| | No protocol is automatically defined as ALL by Terraform. |
