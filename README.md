...
| --- | --- |
| Files | Related resources are grouped together in generated files or use -i command argument to generate one file per resource except security group rules, with one resource per rule, are still grouped together. |
