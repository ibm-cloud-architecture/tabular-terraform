...
| TBD | is_security_group_network_interface_attachment not available. |
| | is_vpc-route, is_network_acl and is_instance/network_interfaces available for Gen1 only. |
