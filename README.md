...
2. All resources should now be supported in Gen2 (x86 only) and Gen1.
...
5. Columns are subject to change when changed in provider, but work is planned to help with this.
